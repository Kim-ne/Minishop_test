                    ...
                    <div class="row widget-grid">
                            ...
                            <div class="card profile-box">
                                <div class="card-body">
                                    ...
                                    <div class="cartoon"><img class="img-fluid"
                                            src="Backend/assets/images/dashboard/cartoon.svg"
                                                ...
                                                <div class="widget-round secondary">
                                                    <div class="bg-round">
                                                        ...
                                                        <svg class="half-circle svg-fill">
                                                            <use href="Backend/assets/svg/icon-sprite.svg#halfcircle">
                                                            </use>
                                                        </svg>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card-body">
                                                <div class="widget-content">
                                                    <div class="widget-round primary">
                                                        <div class="bg-round">
                                                            <svg class="svg-fill">
                                                                <use href="Backend/assets/svg/icon-sprite.svg#tag">
                                                                </use>
                                                            </svg>
                                                            <svg class="half-circle svg-fill">
                                                                <use href="Backend/assets/svg/icon-sprite.svg#halfcircle">
                                        ...
                                        <div class="card-body">
                                            <div class="widget-content">
                                                <div class="widget-round warning">
                                                    <div class="bg-round">
                                                        <svg class="svg-fill">
                                                            <use href="Backend/assets/svg/icon-sprite.svg#return-box">
                                                            </use>
                                                        </svg>
                                                        <svg class="half-circle svg-fill">
                                                            <use href="Backend/assets/svg/icon-sprite.svg#halfcircle">
                                            ...
                                            <div class="card-body">
                                                <div class="widget-content">
                                                    <div class="widget-round success">
                                                        <div class="bg-round">
                                                            <svg class="svg-fill">
                                                                <use href="Backend/assets/svg/icon-sprite.svg#rate">
                                                                </use>
                                                            </svg>
                                                            <svg class="half-circle svg-fill">
                                                                <use href="Backend/assets/svg/icon-sprite.svg#halfcircle">
                                            ...
                                            <div class="row g-sm-4 g-2">
                                                <div class="col-xl-12 col-md-4">
                                                    <div class="light-card balance-card widget-hover">
                                                        <div class="svg-box">
                                                            <svg class="svg-fill">
                                                                <use href="Backend/assets/svg/icon-sprite.svg#income">
                                                                </use>
                                                            </svg>
                                                        </div>
                                                ...
                                                <div class="col-xl-12 col-md-4">
                                                    <div class="light-card balance-card widget-hover">
                                                        <div class="svg-box">
                                                            <svg class="svg-fill">
                                                                <use href="Backend/assets/svg/icon-sprite.svg#expense">
                                                                </use>
                                                            </svg>
                                                        </div>
                                                ...
                                                <div class="col-xl-12 col-md-4">
                                                    <div class="light-card balance-card widget-hover">
                                                        <div class="svg-box">
                                                            <svg class="svg-fill">
                                                                <use
                                                                    href="Backend/assets/svg/icon-sprite.svg#doller-return">
                                                                </use>
                                                            </svg>
                                                        </div>
                                                ...
                                                <li> <span class="recent-circle bg-primary"> </span>
                                                    <div> <span class="f-light f-w-500">Cancelled </span>
                                                        <h4 class="mt-1 mb-0">2,302<span
                                                                class="f-light f-14 f-w-400 ms-1">(Last 6 Month) </span>
                                                        </h4>
                                                    </div>
                                                </li>
                                ...
                                <div class="card-body pt-0">
                                    <ul>
                                        <li class="d-flex">
                                            ...
                                            <div class="w-100 ms-3">
                                                <p class="d-flex justify-content-between mb-2"><span
                                                        class="date-content ">8th March, 2022
                                        ...
                                        <li class="d-flex">
                                            ...
                                            <div class="w-100 ms-3">
                                                <p class="d-flex justify-content-between mb-2"><span
                                                        class="date-content ">15th Oct, 2022
                                        ...
                                        <li class="d-flex">
                                            ...
                                            <div class="w-100 ms-3">
                                                <p class="d-flex justify-content-between mb-2"><span
                                                        class="date-content `">20th Sep, 2022
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><img class="img-fluid img-40 rounded-circle"
                                                                src="Backend/assets/images/dashboard/user/1.jpg" alt="user">
                                                        </td>
                                                        <td class="img-content-box"><a class="d-block f-w-500"
                                                                href="user-profile-2.html">Jane Cooper</a><span
                                                    ...
                                                    <tr>
                                                        <td><img class="img-fluid img-40 rounded-circle"
                                                                src="Backend/assets/images/dashboard/user/2.jpg" alt="user">
                                                        </td>
                                                        <td class="img-content-box"><a class="d-block f-w-500"
                                                    ...
                                                    <tr>
                                                        <td><img class="img-fluid img-40 rounded-circle"
                                                                src="Backend/assets/images/dashboard/user/3.jpg" alt="user">
                                                        </td>
                                                        <td class="img-content-box"><a class="d-block f-w-500"
                                                                href="user-profile-2.html">Leslie Alexander</a><span
                                                    ...
                                                    <tr>
                                                        <td><img class="img-fluid img-40 rounded-circle"
                                                                src="Backend/assets/images/dashboard/user/4.jpg" alt="user">
                                                        </td>
                                                        <td class="img-content-box"><a class="d-block f-w-500"
                                                                href="user-profile-2.html">Travis Wright</a><span
                                                    ...
                                                    <tr>
                                                        <td><img class="img-fluid img-40 rounded-circle"
                                                                src="Backend/assets/images/dashboard/user/5.jpg" alt="user">
                                                        </td>
                                                        <td class="img-content-box"><a class="d-block f-w-500"
                                                                href="user-profile-2.html">Mark Green</a><span
                        ...
                        <div class="col-xxl-3 col-md-6 box-col-6 col-ed-none wow zoomIn">
                            <div class="card purchase-card"><img class="img-fluid"
                                    src="Backend/assets/images/dashboard/purchase.png" alt="vector mens with leptop">
                        ...
                        <div class="col-xxl-5 col-lg-8 col-md-11 box-col-8 col-ed-6">
                            <div class="card papernote-wrap">
                                <div class="card-header card-no-border">
                                    <div class="header-top">
                                        <h5>PaperNote</h5><a class="f-light d-flex align-items-center" href="#">View
                                            project <i class="f-w-700 icon-arrow-top-right"></i></a>
                                    </div>
                                </div>
                                <div class="card-body pt-0"> <img class="banner-img img-fluid"
                                        src="Backend/assets/images/dashboard/papernote.jpg" alt="multicolor background">
                                        ...
                                        <div class="mt-sm-4 mt-2 user-details">
                                            <div class="customers">
                                                <ul>
                                                    ...
                                                    <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                            src="Backend/assets/images/dashboard/user/6.jpg" alt="user">
                                                    </li>
                                                    <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                            src="Backend/assets/images/dashboard/user/7.jpg" alt="user">
                                                    </li>
                                                    <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                            src="Backend/assets/images/dashboard/user/3.jpg" alt="user">
                                                    </li>
                                                    <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                            src="Backend/assets/images/dashboard/user/8.jpg" alt="user">
                                                    </li>
