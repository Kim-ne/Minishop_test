...
<body>
    ...
    <!-- Categories Start -->
    @include('frontend.partial.category', ['categories' => $categories])

    <!-- Categories End -->


    <!-- Products Start -->
    @include('frontend.partial.feature_product',['products' => $products])
    <!-- Products End -->
    ...
    <!-- Products Start -->
   @include('frontend.partial.recent_product',['productsRecent' => $productsRecent])
    <!-- Products End -->
