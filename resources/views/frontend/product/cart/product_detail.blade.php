            ...
            <div class="row px-xl-5">
                <div class="col-12">
                    <nav class="breadcrumb bg-light mb-30">
                        <a class="breadcrumb-item text-dark" href="{{ asset('/') }}">Home</a>
                        <a class="breadcrumb-item text-dark" href="{{ asset('/products') }}">Product</a>
                ...
                <div class="col-lg-7 h-auto mb-30">
                    <div class="h-100 bg-light p-30">
                        ...
                        <div class="d-flex mb-3">
                            ...
                            <small class="pt-1">({{ rand(1, 99) }})</small>
                        </div>
                        <h3 class="font-weight-semi-bold mb-4">{{ number_format($product->price * 1000) }} VND</h3>
                    ...
                    <div class="bg-light p-30">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="tab-pane-3">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4 class="mb-4">1 review for "{{ Str::ucfirst($product->name) }}"</h4>
                                ...
                                <div class="product-img position-relative overflow-hidden">
                                    ...
                                    <div class="product-action">
                                        {{-- <a class="btn btn-outline-dark btn-square"
                                            href="{{ route('product.detail', $item->alias) }}"><i
